...
export default async function BillingPage({ searchParams }: Props) {
  ...
  if (isAgency) {
    ...
    return (
      <div className="q-billing-wrap">
        ...
        {/* Subscription card */}
        <div style={{ borderRadius: 14, border: '1px solid rgba(255,255,255,.07)', background: '#0c0c10', boxShadow: '0 0 60px rgba(212,255,63,.08)', padding: '20px 22px', display: 'flex', flexDirection: 'column', gap: 16 }}>
  ...
  return (
    <div className="q-billing-wrap">
      ...
      {/* Balance hero */}
      <div style={{ borderRadius: 14, border: '1px solid rgba(255,255,255,.07)', background: '#0c0c10', boxShadow: '0 0 60px rgba(212,255,63,.08)', padding: '20px 22px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 12 }}>
            <span style={{ width: 7, height: 7, borderRadius: '50%', background: isLow ? '#e0a04f' : '#D4FF3F', boxShadow: isLow ? '0 0 8px rgba(224,160,79,.6)' : '0 0 8px rgba(212,255,63,.6)', flexShrink: 0, animation: 'dot-pulse 2.4s ease-in-out infinite' }} />
          ...
          <div style={{ textShadow: '0 0 40px rgba(212,255,63,.4)' }}>
            ...
            {sparkline.map((val, i) => (
              <div
                ...
                style={{
                  ...
                  background: val === 0 ? 'rgba(255,255,255,.07)' : 'rgba(212,255,63,.55)',
