  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: 'clamp(4rem,8vw,7rem) 1.5rem' }}>
      ...
      <Section title="6. Intellectual property">
        <p><strong style={{ color: 'var(--qp-ink)' }}>Your content.</strong> You retain ownership of any content, product descriptions, images, and other materials you upload or provide to the Service.</p>
        <p style={{ marginTop: 10 }}><strong style={{ color: 'var(--qp-ink)' }}>Generated output.</strong> The storefront code, manifests, and other files generated by Quante on your behalf are owned by you. Quante grants you a perpetual, worldwide, royalty-free licence to use, modify, and distribute this output, including for commercial purposes. The generated output carries no Quante branding, watermarks, or telemetry.</p>
        <p style={{ marginTop: 10 }}><strong style={{ color: 'var(--qp-ink)' }}>Platform.</strong> The Quante platform, its codebase, design system, and AI scaffolding remain the exclusive property of {operator.name}. Nothing in these Terms transfers any rights in the platform to you.</p>
      </Section>
