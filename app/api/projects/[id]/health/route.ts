...
export async function GET(_request: Request, { params }: Params) {
  ...
  const [versionResult, codeResult, deploymentResult, secretsResult] = await Promise.all([
    supabaseAdmin
  ...
  const manifest = (versionResult.data?.manifest as ShopManifest | undefined) ?? null
