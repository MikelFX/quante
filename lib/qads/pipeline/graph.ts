...
export const QADS_PIPELINE_GRAPH: QadsNodeDef[] = [
  ...
  { id: 'video_prompts', label: 'Planning video creative', dependsOn: ['ad_sets'], implemented: true },
  { id: 'video', label: 'Generating video', dependsOn: ['video_prompts'], implemented: true },
